        ...
        case "erp":
            return (
                <div className={cn("relative w-24 h-24", className)}>
                    <svg viewBox="0 0 100 100" className="w-full h-full text-secondary fill-none stroke-current stroke-2">
                        {/* Central hub */}
                        <circle cx="50" cy="50" r="12" className="fill-secondary/20 animate-pulse-slow" />
                        <rect x="43" y="43" width="14" height="14" rx="3" className="animate-float" />
                        {/* Surrounding modules */}
                        <rect x="15" y="15" width="18" height="18" rx="3" className="fill-secondary/10 animate-pulse" />
                        <rect x="67" y="15" width="18" height="18" rx="3" className="fill-secondary/10 animate-pulse delay-100" />
                        <rect x="15" y="67" width="18" height="18" rx="3" className="fill-secondary/10 animate-pulse delay-200" />
                        <rect x="67" y="67" width="18" height="18" rx="3" className="fill-secondary/10 animate-pulse delay-300" />
                        {/* Connections from center to modules */}
                        <path d="M44 44 L33 33" className="animate-pulse-slow" strokeDasharray="3 2" />
                        <path d="M56 44 L67 33" className="animate-pulse-slow" strokeDasharray="3 2" />
                        <path d="M44 56 L33 67" className="animate-pulse-slow" strokeDasharray="3 2" />
