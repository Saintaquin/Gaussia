...
export function SlideSection({
    ...
    return (
        <section
            id={id}
            className={cn(
                "min-h-screen flex items-center justify-center p-6 sm:p-12 relative overflow-hidden snap-start",
                variants[variant]
            )}
        >
            <div className="absolute inset-0 w-full h-full pointer-events-none opacity-20">
                <div className="absolute top-20 left-20 w-64 h-64 bg-current rounded-full blur-3xl opacity-20 animate-pulse-slow" />
                <div className="absolute bottom-20 right-20 w-80 h-80 bg-current rounded-full blur-3xl opacity-20 animate-pulse-slow delay-1000" />
            </div>
            ...
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    <div className="relative z-10 w-full aspect-square md:aspect-video lg:aspect-square flex items-center justify-center rounded-3xl bg-white/50 backdrop-blur-xl border border-white/20 shadow-2xl p-8 transform rotate-1 transition-transform hover:rotate-0">
                        {/* Placeholder for illustration - currently reusing icon but larger or a specific graphic could go here */}
