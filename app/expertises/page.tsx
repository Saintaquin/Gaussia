...
export const metadata: Metadata = {
  title: "Nos Expertises — Automatisation, Data & Cloud",
  description:
    "Découvrez nos expertises : automatisation des processus métiers (n8n, Make), data analytics & business intelligence, cloud & déploiement. Agence digitale à Paris.",
  keywords: [
  ...
  alternates: {
    canonical: "https://gaussia.fr/expertises",
  },
  openGraph: {
    title: "Nos Expertises — Automatisation, Data & Cloud | GAUSSIA",
    description: "Automatisation, data analytics et cloud : nos 3 domaines d'expertise pour transformer votre entreprise.",
    url: "https://gaussia.fr/expertises",
  },
}
  ...
  "@graph": [
    {
      ...
      "description": "Automatisation du reporting, gestion automatisée des emails, intégration CRM, workflows métiers personnalisés avec n8n et Make.",
      "serviceType": "Automatisation des processus métiers",
      "areaServed": "FR"
    },
    {
      "@type": "Service",
      "name": "Data & Analytics",
      "provider": { "@id": "https://gaussia.fr/#organization" },
      "description": "Modélisation et architecture de données, dashboards interactifs, intégration multi-sources, business intelligence et analyse prédictive.",
      "serviceType": "Business Intelligence & Analytics",
      "areaServed": "FR"
    },
    {
      "@type": "Service",
      "name": "Cloud & Déploiement",
      "provider": { "@id": "https://gaussia.fr/#organization" },
      "description": "Infrastructure serverless, microservices, solutions scalables haute performance, sécurité et conformité des données, architecture cloud multi-plateforme.",
      "serviceType": "Cloud Computing & Déploiement",
      "areaServed": "FR"
    }
  ]
}
