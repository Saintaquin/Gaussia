...
export const metadata: Metadata = {
  title: "Notre Méthodologie — Audit, Conception & Accompagnement",
  description:
    "Découvrez notre méthodologie en 3 étapes : audit & analyse, conception & développement agile, déploiement & accompagnement. Une approche structurée pour garantir le succès de votre transformation digitale.",
  keywords: [
    "audit digital",
    "méthodologie agile",
    ...
    "formation équipes",
    "ROI transformation digitale",
  ],
  alternates: {
    canonical: "https://gaussia.fr/methodologie",
  },
  openGraph: {
    title: "Notre Méthodologie — Audit, Conception & Accompagnement | GAUSSIA",
    description: "Méthodologie en 3 étapes pour garantir le succès de votre transformation digitale. Audit gratuit.",
    url: "https://gaussia.fr/methodologie",
  },
}
...
const jsonLd = {
  ...
  "@type": "HowTo",
  "name": "Méthodologie de transformation digitale GAUSSIA",
  "description": "Notre approche structurée en 3 étapes pour garantir le succès de votre transformation digitale et maximiser votre retour sur investissement.",
  "step": [
    {
      "@type": "HowToStep",
      "name": "Audit & Analyse",
      "text": "Analyse approfondie de votre écosystème actuel, vos processus métiers et vos besoins spécifiques. Cartographie des workflows, audit technique et identification des opportunités d'amélioration. Durée : 1-2 semaines.",
      "position": 1
    },
    {
      "@type": "HowToStep",
      "name": "Conception & Développement",
      "text": "Conception d'une solution sur-mesure, architecture technique optimale, développement agile itératif avec validation continue, tests complets et validation utilisateur. Durée : 2-4 semaines.",
      "position": 2
    },
    {
      "@type": "HowToStep",
      "name": "Déploiement & Accompagnement",
      "text": "Mise en production progressive et sécurisée, formation complète des utilisateurs, accompagnement post-déploiement et maintenance continue. Durée : 1-2 semaines + suivi.",
      "position": 3
    }
  ]
}
      ...
      <div className="min-h-screen py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl lg:text-5xl font-bold text-slate-900 mb-6">Notre méthodologie</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-slate-900">Audit & Analyse</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-900">Analyse des processus existants</h4>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Audit technique</h4>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Identification des opportunités</h4>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Durée : 1-2 semaines</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1">
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold text-slate-900 mb-4">Durée : 2-4 semaines</h3>
                    <p className="text-gray-600">
              ...
              <div className="order-1 lg:order-2">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-slate-900">Conception & Développement</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Architecture technique</h4>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Développement agile</h4>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Tests et validation</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h2 className="text-3xl font-bold text-slate-900">Déploiement & Accompagnement</h2>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Déploiement sécurisé</h4>
                  ...
                  <div className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-3 mt-1" />
                    <div>
                      <h4 className="font-semibold text-slate-900">Formation des équipes</h4>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900 mb-4">Durée : 1-2 semaines + suivi</h3>
                  <p className="text-gray-600">
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">Prêt à démarrer votre projet ?</h2>
